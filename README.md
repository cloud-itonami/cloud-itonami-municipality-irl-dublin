# cloud-itonami-municipality-irl-dublin

Municipal-ordinance compliance catalog for **Dublin** — the
FORTY-THIRD municipality-level entry alongside
...
Ireland's first entry across any of the 3 axes.

## Sourcing note

Ireland's official government domains (`irishstatutebook.ie`,
`dublincity.ie`, `gov.ie`) all returned HTTP 403 on every URL tried,
so this catalog's entries instead cite `en.wikipedia.org`, directly
WebFetched and read (not merely WebSearch-cited).

## Scope

A **read-only reference/archive** catalog — not an Advisor⊣Governor
actuation actor. It proposes or executes nothing on Dublin City
Council's behalf.
...
Both entries directly confirmed via Wikipedia: the **Municipal
Corporations (Ireland) Act 1840** (establishing the modern unicameral
council, first elected October 1841) and the **Local Government Act
2001** (the current governing legislation, effective 1 January 2002,
which renamed Dublin Corporation to Dublin City Council).
...
festivals and heritage sites for Dublin:
...
remains Ireland's; this repo stores only citation metadata
